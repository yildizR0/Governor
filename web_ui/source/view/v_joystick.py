...
class JoystickView():
    ...
    def initiate_ui(self):
        ...
        # Timer, der alle 50ms die Koordinaten sendet
        def send_coordinates():
            e = self.joystick.get_value()  # aktuelle Position
            self.vm.coordinates(f'{e.x:.3f}', f'{e.y:.3f}')

        ui.timer(0.05, send_coordinates) 